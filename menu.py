...
def request_char():
	font = pygame.font.Font("assets/font/8-BIT WONDER.TTF", 30)
	character1 = entities.Button(-150, 80, char_style1)
	character2 = entities.Button(300, 60, char_style2)
	character3 = entities.Button(700, 40, char_style3)

	run = True
	while run:
		if character1.draw() == True:
			# action
			print('You chose Character 1')
		elif character2.draw() == True:
			# action
			print('You chose Character 2')
		elif character3.draw() == True:
			# action
		...
		screen.blit(char_style1, (-150, 80))
		screen.blit(char_style2, (300, 60))
		screen.blit(char_style3, (700, 40))
		pygame.display.flip()
